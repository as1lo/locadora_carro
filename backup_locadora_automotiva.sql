CREATE DATABASE  IF NOT EXISTS `locadora_automotiva` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `locadora_automotiva`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: locadora_automotiva
-- ------------------------------------------------------
...
CREATE TABLE `aluguel` (
  ...
  `alu_fk_forma_pagamento` int DEFAULT NULL,
...
INSERT INTO `automovel` VALUES (1,'Carro','Hatchback','7899ERT',1,'Branco','Apresenta leve arranhão na parte traseira','2014-07-03',1),(2,'Carro','SUV','X43Z78C',2,'Azul','N/A','2020-06-05',1);
...
INSERT INTO `marca` VALUES (1,'Fiat'),(2,'Citroen');
...
INSERT INTO `modelo` VALUES (1,'Uno',1),(2,'Aircross',2);
...
CREATE TABLE `vendas` (
  ...
  `ven_fk_forma_pagamento` int DEFAULT NULL,
...
CREATE TABLE `vendas_automovel` (
  `venaut_id` int NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2024-03-10 22:50:28
